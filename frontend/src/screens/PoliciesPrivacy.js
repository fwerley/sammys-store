...
export default function PoliciesPrivacy() {
    return (
        <Container className='small-container' style={{ textAlign: 'justify' }}>
            Esta política é válida a partir de Fevereiro de 2023.

            <h3 className='my-3'>Política de Privacidade - Sammy's Store</h3>

            <p>Sammy's Store, pessoa jurídica de direito privado leva a sua privacidade a sério e zela pela segurança e proteção de dados de todos os seus clientes, parceiros, fornecedores e usuários do site domínio https://sammystore.com.br e qualquer outro site, loja ou aplicativo operado pelo lojista.</p>
            ...
            <strong>AO ACESSAR A LOJA, ENVIAR COMUNICAÇÕES OU FORNECER QUALQUER TIPO DE DADO PESSOAL, VOCÊ DECLARA ESTAR CIENTE COM RELAÇÃO AOS TERMOS AQUI PREVISTOS E DE ACORDO COM A POLÍTICA DE PRIVACIDADE, A QUAL DESCREVE AS FINALIDADES E FORMAS DE TRATAMENTO DE SEUS DADOS PESSOAIS QUE VOCÊ DISPONIBILIZAR NA LOJA.</strong>

            <p>Esta Política de Privacidade fornece uma visão geral de nossas práticas de privacidade e das escolhas que você pode fazer, bem como direitos que você pode exercer em relação aos Dados Pessoais tratados por nós. Se você tiver alguma dúvida sobre o uso de Dados Pessoais, entre em contato com contato@sammysotre.com.br.</p>
            ...
            <h5>Seção 1 - Definições</h5>
            Para os fins desta Política de Privacidade:<br />
            <ol>
                ...
                <li><strong>"Leis de Proteção de Dados"</strong>: significa todas as disposições legais que regulam o Tratamento de Dados Pessoais, incluindo, porém sem se limitar, a Lei nº 13.709/18, Lei Geral de Proteção de Dados Pessoais ("LGPD").</li>
            </ol>

            <h5>Seção 2 - Uso de Dados Pessoais</h5>
            ...
            <h5>Seção 3 - Não fornecimento de Dados Pessoais</h5>
            ...
            <ol>
                <li><strong>Dados de contato:</strong> nome, sobrenome, número de telefone, endereço, cidade, estado e endereço de e-mail;</li>
                <li><strong>Informações enviadas:</strong> informações que você envia via formulário (dúvidas, reclamações, sugestões, críticas, elogios etc.).</li>
            </ol>
            ...
            <h5>Seção 6 - Transferências internacionais de dados</h5>
            ...
            <h5>Seção 7 - Coleta automática de Dados Pessoais</h5>
            ...
            <ol>
                ...
                <li><strong>Uso de pixel tags e outras tecnologias similares:</strong> pixel tags (também conhecidos como Web beacons e GIFs invisíveis) podem ser utilizados para rastrear ações de usuários da loja (incluindo destinatários de e-mails), medir o sucesso das nossas campanhas de marketing e coletar dados estatísticos sobre o uso da loja e taxas de resposta, e ainda para outros fins não especificados. Podemos contratar empresas de publicidade comportamental, para obter relatórios sobre os anúncios da loja em toda a internet. Para isso, essas empresas utilizam cookies, pixel tags e outras tecnologias para coletar informações sobre a sua utilização, ou sobre a utilização de outros usuários, da nossa loja e de site de terceiros. Nós não somos responsáveis por pixel tags, cookies e outras tecnologias similares utilizadas por terceiros.</li>
            </ol>
            <h5>Seção 8 - Categorias de cookies</h5>
            Os cookies utilizados na nossa loja estão de acordo com os requisitos legais e são enquadrados nas seguintes categorias:

            <ol>
                <li><strong>Estritamente necessários:</strong> estes cookies permitem que você navegue pelo site e desfrute de recursos essenciais com segurança. Um exemplo são os cookies de segurança, que autenticam os usuários, protegem os seus dados e evitam a criação de logins fraudulentos.</li>
                <li><strong>Desempenho:</strong> os cookies desta categoria coletam informações de forma codificada e anônima relacionadas à nossa loja virtual, como, por exemplo, o número de visitantes de uma página específica, origem das visitas ao site e quais as páginas acessadas pelo usuário. Todos os dados coletados são utilizados apenas para eventuais melhorias no site e para medir a eficácia da nossa comunicação.</li>
                <li><strong>Funcionalidade:</strong> estes cookies são utilizados para lembrar definições de preferências do usuário com o objetivo de melhorar a sua visita no nosso site, como, por exemplo, configurações aplicadas no layout do site ou suas respostas para pop-ups de promoções e cadastros -; dessa forma, não será necessário perguntar inúmeras vezes.</li>
                <li><strong>Publicidade:</strong> utilizamos cookies com o objetivo de criar campanhas segmentadas e entregar anúncios de acordo com o seu perfil de consumo na nossa loja virtual.</li>
            </ol>
            <h5>Seção 9 - Direitos do Usuário</h5>
            <p>Você pode, a qualquer momento, requerer:<br />
                &nbsp;(i) confirmação de que seus Dados Pessoais estão sendo tratados;<br />
                &nbsp;(ii) acesso aos seus Dados Pessoais;<br />
                &nbsp;(iii) correções a dados incompletos, inexatos ou desatualizados; <br />
                &nbsp;(iv) anonimização, bloqueio ou eliminação de dados desnecessários, excessivos ou tratados em desconformidade com o disposto em lei; <br />
                &nbsp;(v) portabilidade de Dados Pessoais a outro prestador de serviços, contanto que isso não afete nossos segredos industriais e comerciais;<br />
                &nbsp;(vi) eliminação de Dados Pessoais tratados com seu consentimento, na medida do permitido em lei;<br />
                &nbsp;(vii) informações sobre as entidades às quais seus Dados Pessoais tenham sido compartilhados;<br />
                &nbsp;(viii) informações sobre a possibilidade de não fornecer o consentimento e sobre as consequências da negativa; e <br />
                &nbsp;(ix) revogação do consentimento. Os seus pedidos serão tratados com especial cuidado de forma a que possamos assegurar a eficácia dos seus direitos. Poderá lhe ser pedido que faça prova da sua identidade de modo a assegurar que a partilha dos Dados Pessoais é apenas feita com o seu titular.</p>
            ...
            <h5>Seção 10 - Segurança dos Dados Pessoais</h5>
            ...
            <h5>Seção 11 - Links de hipertexto para outros sites e redes sociais</h5>
            ...
            <h5>Seção 12 - Atualizações desta Política de Privacidade</h5>
            ...
            <h5>Seção 13 - Encarregado do tratamento dos Dados Pessoais</h5>
            <p>Caso pretenda exercer qualquer um dos direitos previstos, inclusive retirar o seu consentimento, nesta Política de Privacidade e/ou nas Leis de Proteção de Dados, ou resolver quaisquer dúvidas relacionadas ao Tratamento de seus Dados Pessoais, favor contatar-nos em contato@sammysotre.com.br.</p>
        </Container>
    )
}
